...
public function getUserByUsername(Request $request, Response $response, $args)
{
    ...
    try {
        ...
        if ($userStatus !== 2) {
            ...
            return $response->withStatus(403)->withHeader('Content-Type', 'application/json')->getBody()->write($responseBody);
        }
        ...
        $user['connectedUsername'] = $decodedToken->username; // Access claim directly
